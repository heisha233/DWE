...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--data_dir', default='./GlaS/image')
    ...
    if args.if_RGB:
        ...
        print("mean_r is %f, mean_g is %f, mean_b is %f" % (mean_1, mean_2, mean_3))
    else:
        mean_1 = channel_1 / pixels_num
        print("mean is %f" % (mean_1))
    ...
    if args.if_RGB:
        ...
        print("std_r is %f, std_g is %f, std_b is %f" % (std_1, std_2, std_3))
    else:
        std_1 = np.sqrt(channel_1 / pixels_num)
        print("std is %f" % (std_1))